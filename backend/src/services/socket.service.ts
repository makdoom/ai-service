...
class SocketService {
  ...
  private setupListeners() {
    ...
    this.io.on("connection", (socket) => {
      ...
      // Join a user-specific room for real-time updates to a single user (across tabs)
  ...
  // Helper function to emit events to a specific user (all their active tabs/devices)
  ...
  // Helper function to emit events to a specific socket connection only
